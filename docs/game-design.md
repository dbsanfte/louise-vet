...
clear side aisle. **Courtyard** and **Whole clinic** camera controls include the
new space. It stays clear of pavements, roads and neighbouring houses, and leaves
...
active only in Hookville, outside dialogs and text-entry controls. Mouse orbit,
touch gestures, zoom and the fixed clinic-return button remain available.
...
| Soft bandage   | Follow six numbered arrows around the paw in order; a wrong step leaves the current wrap unchanged.                                                                        |
...
| Fine forceps   | Grip the splinter, then ease to three successive marks, pausing at each for 0.65 active seconds. Pulling past a mark prompts a steadier retry.                             |
| Cooling pad    | Follow a slowly moving comfort guide with the pad for 2.5 seconds of accumulated alignment. Losing alignment gradually reduces settling progress.                          |
...
cream patches and wrapping steps are also individually focusable buttons. Colour
...
The equipment upgrade widens alignment/pressure/fill guides; coverage and sequence
activities keep the same six readable steps. Exact scoring and tolerances belong
in section 8.
...
- Reception and Hookville fill the available browser viewport, including short desktop windows
  ...
  **Patients** and **While you wait** switch the sidebar between patients and
  ...
  They support touch and keyboard focus. **While you wait** lists active rides,
...
| Steady-paw tool kit    | 150           | Widens alignment, pressure and fill guide half-width from 0.12 to 0.18 on the normalized 0–1 scale.                                |
