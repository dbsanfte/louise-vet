...
Rotate has a button and R shortcut; on-screen nudge and confirmation controls also
support keyboard and touch placement. The collection scrolls internally; feedback,
...
Build implementation: [layout, migration and navigation](../src/clinic-build.ts), [editor controls](../src/clinic-build-editor.ts), [floor/fence rendering](../src/clinic-build-scenery.ts), [movable models](../src/clinic-furniture.ts), [unloading and routing](../src/clinic-leisure.ts), [unit checks](../tests/clinic-build.test.ts), [browser checks](../tests/clinic-build.spec.ts).
