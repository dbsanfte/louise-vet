...
an area is used; there is no furnishing checklist or assigned room type. Choose
**Interior** to add low walls (or a picket fence for garden tiles), or **Exterior**
to leave the new area open without a new internal boundary. These labels replace
With walls/Open space; automatic connections and exterior plot boundaries remain.
...
Interior is the default; Exterior omits the new partition but
...
stays in place, with its furniture inactive until a floor/door connection is
restored. No tiles outside the rectangle are silently deleted or filled in.
...
supply floor-tile kits and unlock shop categories, while retaining the original
...
The **Play garden extension** supplies a floor-tile kit and unlocks these separately
purchased activities. Migrated clinics keep their existing six-by-eight garden
...
Place and rearrange the unlocked items using Build. Dispenser refills are included and do not consume retail treat stock.
...
The **Sunshine courtyard** kit is available after Pet playground, leaves patient
capacity at eight, and unlocks a two-seat **Puzzle picnic table** plus three pet
...
| Pet playground         | 300           | 84 free floor tiles and a stored toy corner; capacity six to eight; requires Room for more paws.                                            |
...
| Play garden extension  | 300           | 48 free floor tiles and six new shop activities; requires Pet playground; capacity stays eight.                                             |
...
| Sunshine courtyard     | 360           | 48 free floor tiles and courtyard shop activities; requires Pet playground; capacity stays eight.                                           |
...
second corner tap builds immediately, charges once, and adds connecting doors;
...
catalogue. Interior/Exterior replace the old boundary labels.
...
Interior/Exterior replace the boundary labels. Fixed anchors, nearby snapping and
